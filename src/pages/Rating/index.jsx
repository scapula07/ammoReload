...
const RatingBoard=()=>{
    ...
    <div className='w-full flex flex-col space-y-4'>
        <main className='flex w-full lg:justify-end'>
            <button className='lg:py-4 py-2 px-10 rounded-md bg-blue-900 text-white lg:text-sm text-xs' >Review/Rate Dealer</button>
        </main>
...
const ReviewCard=()=>{
    return(
        <div className='w-full'>
            <div className='lg:w-5/6 w-full flex lg:flex-row flex-col lg:items-center lg:justify-between space-y-4 lg:space-y-0'>
                <h5 className='lg:text-xl  font-semibold' style={{color: "#3F3F46"}}> Easy, Fast, maximum satisfaction </h5>
                <main className='flex '>
                    {[1,2,3,4].map(()=>
            ...
            <p className='text-sm font-light lg:w-5/6 py-4' >Lorem ipsum dolor sit amet consectetur. Morbi facilisi eget lobortis ut mattis auctor. Lorem ipsum dolor sit amet consectetur. Morbi facilisi eget lobortis ut mattis auctorLorem ipsum dolor sit amet consectetur. Morbi . dolor sit amet consectetur. Morbi </p>
             
            <div className='lg:w-5/6 flex items-center space-x-4'>
                <main className='flex items-center space-x-4'>
                    <h5 className='lg:text-sm text-xs '>@JUDE Gray</h5>
                    <h5 className='lg:text-sm text-xs font-light'>Joined : Nov 12, 2023</h5>
                    <h5 className='lg:text-sm text-xs font-light'>Posted : Nov 12, 2023/ 10:00am</h5>
...
export default function Ratings() {
  return (
    <div className='lg:px-20 px-6'>
        <h5 className='lg:text-3xl text-xl font-semibold'>Ammo dealers (1000)</h5>

        <div className='flex lg:flex-row flex-col py-4 w-full justify-between'>
            <main className='lg:w-4/12 w-full'>
              <select className='border text-sm font-semibold  w-full py-2 px-6 rounded-md'>
                 <option>Dealers (1000)</option>
              </select>

              <div className='lg:flex flex-col space-y-8 overflow-y-scroll py-8 hidden' style={{height:"100vh"}}>
                {[1,2,3,4,4,4,5].map(()=>{
                     return(
               ...
               <main className='py-8'>
                        <div className='lg:hidden flex items-center space-x-4 bg-blue-900 hover:text-white py-3 px-2 text-white'>
                                    <img src={result} className="w-20 h-20"/>
                                    <main className='flex flex-col space-y-2'>
                                        <h5 className=' font-semibold text-sm'>Target Sport Factory USA</h5>
                                        <p className='text-xs font-light '>Lorem ipsum dolor sit amet consectetur. Morbi facilisi eget lobortis ut mattis auctor. </p>
                                        ...
                                        <div className='flex items-center space-x-2 '>
                                            ...
                                            <h5 className='bg-slate-200 text-xs px-1 py-0.5 font-light rounded-md' style={{color:"black"}}>100 Reviews</h5>
                                            <h5 className='bg-slate-200 text-xs px-1 py-0.5 font-light rounded-md' style={{color:"black"}}>100+ products</h5>
